...
export default function FancyTestimonialSliderPage() {
  ...
  return (
    <>
      ...
      <Banner
        tutorialUrl="https://cruip.com/how-to-build-a-fancy-testimonial-slider-with-tailwind-css-and-next-js/"
        downloadUrl="https://github.com/cruip/cruip-tutorials-next/blob/main/components/fancy-testimonials-slider.tsx"
      />
    </>
  );
}
