...
export default function VerticalTimelinePage() {
  ...
  return (
    <>
      ...
      <Banner
        tutorialUrl="https://cruip.com/3-examples-of-brilliant-vertical-timelines-with-tailwind-css/"
        downloadUrl="https://github.com/cruip/cruip-tutorials-next/blob/main/components/vertical-timeline-01.tsx"
      />
    </>
  );
}
