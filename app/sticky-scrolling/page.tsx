    ...
    <>
      <main className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-slate-50 supports-[overflow:clip]:overflow-clip">
        <div className="mx-auto w-full max-w-6xl px-4 py-24 md:px-6">
          <div className="flex h-[calc(100vh-6rem)] items-center justify-center text-center text-4xl font-bold text-slate-300">
            Scroll down
          </div>
            ...
            <div className="space-y-16 lg:sticky lg:top-0 lg:h-screen lg:space-y-0">
              {sections.map((section, index) => (
                <section
                  ...
                  key={index}
                  style={
                    { "--stick-visibility": 0, "--stick-scale": 0.8 } as any
                  }
                >
      ...
      <Banner
        tutorialUrl="https://cruip.com/how-to-create-a-sticky-on-scroll-effect-with-javascript/"
        downloadUrl="https://github.com/cruip/cruip-tutorials-next/blob/main/components/sticky-scrolling.tsx"
      />
    </>
  );
}
