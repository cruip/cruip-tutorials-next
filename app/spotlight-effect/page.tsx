...
export default function SpotlightPage() {
  return (
    <>
      ...
      <Banner tutorialUrl="https://cruip.com/how-to-create-a-spotlight-card-hover-effect-with-tailwind-css/" downloadUrl="https://github.com/cruip/cruip-tutorials-next/blob/main/components/spotlight.tsx" />
    </>
  )
}